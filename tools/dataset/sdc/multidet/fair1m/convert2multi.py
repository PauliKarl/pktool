...
covertedCLASSES = {'Passenger Ship':'Loose pulley', 'Motorboat':'Motorboat', 'Fishing Boat':'Fishing boat', 'Tugboat':'Tugboat', 'Engineering Ship':'Engineering ship', 'Liquid Cargo Ship':'Cargo vessel', 'Dry Cargo Ship':'Cargo vessel', 'Warship':'Warship', 'other-ship':'Ship'}

xml_path = '/data2/pd/fair1m/train/part1/labelXmls/'
filtered_label_path = '/data2/pd/sdc/multidet/fair1m/v0/trainval/labels/'
...
for idx, xmlfile in enumerate(xmlList):
    ...
    for single_object in objects:
        ...
        if single_object['label'] in FilteredCLASSES:
            have_count+=1
            single_object['label'] = covertedCLASSES[single_object['label']]
