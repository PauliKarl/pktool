...
CLASSES = {'Frigate': 1, 'Cruiser': 2, 'Aircraft carrier': 3, 'Ship': 4, 'Amphibious ship': 5, 'Cargo vessel': 6, 'Destroyer': 7, 'Warship': 8, 'Loose pulley': 9, 'Command ship': 10, 'Hovercraft': 11, 'Submarine': 12,'Motorboat':13,'Fishing boat':14,'Tugboat':15,'Engineering ship':16}
...
def split_all_to_SDC():
    datasets_type = ['ext']#'hrsc2016','fair1m',
