...
if __name__=="__main__":
    datasets_type=['hrsc2016','ext']
    datasets = ['test','trainval']
    #每子数据集都按照8：2的比例划分训练集和测试集        
    trainval_dir = '/data2/pd/sdc/multidet/v0/trainval'
    test_dir = '/data2/pd/sdc/multidet/v0/test'
    for dataset_type in datasets_type:
        for dataset in datasets:
            splited_dataset_path = '/data2/pd/sdc/multidet/{}/v1/{}/'.format(dataset_type,dataset)
