...
if __name__=='__main__':
    ...
    """
    img_path = '/data/pd/sdc/v1/coco/test/'
    label_path = '/home/pd/AerialDetection/work_dirs/sdc/faster_rcnn_obb_r50_fpn_1x_sdc/Task1_results_nms/person.txt'
